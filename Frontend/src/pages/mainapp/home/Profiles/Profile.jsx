        ...
        <div className="mainbox">
            <div className="innermainbox">
                <div className="name-dp-id">
                    <img className='dp987' src={myinfo?.profilepic !== null ? myinfo?.profilepic : "https://w7.pngwing.com/pngs/340/946/png-transparent-avatar-user-computer-icons-software-developer-avatar-child-face-heroes.png"} alt="image" />
